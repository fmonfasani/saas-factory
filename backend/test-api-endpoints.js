...
async function runTests() {
  ...
  // Test 3: GET /api/organizations/:id/projects
  await testGetProjects();
  
  // Test 4: POST /api/organizations/:id/projects
  await testCreateProject();
  
  // Test 5: PUT /api/organizations/:id/projects/:projectId
  await testUpdateProject();
  
  // Test 6: DELETE /api/organizations/:id/projects/:projectId
